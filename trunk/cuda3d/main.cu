...
#define BLOCKDIM_X	 13
#define BLOCKDIM_Y	 13
#define BLOCKDIM_Z	 1
...
cudaExtent volumeSize = make_cudaExtent(86, 86, 22);
...
unsigned char* loadRawFile(char *filename, size_t size){
