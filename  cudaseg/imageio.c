...
extern read_tiff_header(file_name, image_header){
   char file_name[];
...
extern extract_long_from_buffer(buffer, lsb, start, number){
   char  buffer[];
   int       lsb, start;
   long  *number;
...
extern extract_ulong_from_buffer(buffer, lsb, start, number){
   char  buffer[];
   int       lsb, start;
...
extern extract_short_from_buffer(buffer, lsb, start, number){
   char  buffer[];
   int       lsb, start;
   short *number;
...
extern extract_ushort_from_buffer(buffer, lsb, start, number){
   char  buffer[];
   int       lsb, start;
...
extern short **allocate_image_array(length, width){
   long  length, width;
...
extern int free_image_array(the_array, length){
   short **the_array;
   long  length;
...
extern read_tiff_image(image_file_name, the_image){
...
extern read_line(image_file, the_image, line_number, image_header, ie, le){
   FILE   *image_file;
...
extern seek_to_first_line(image_file, image_header, il){
   FILE   *image_file;
   int    il;
   struct tiff_header_struct *image_header;
...
extern seek_to_end_of_line(image_file, le, image_header){
   FILE   *image_file;
   int    le;
   struct tiff_header_struct *image_header;
...
extern create_tiff_file_if_needed(in_name, out_name, out_image){
...
extern create_allocate_tiff_file(file_name, image_header){
   char   file_name[];
   struct tiff_header_struct *image_header;
...
extern write_tiff_image(image_file_name, array){
...
extern write_line(image_file, array, line_number, image_header, ie, le){
   FILE   *image_file;
   int    ie, le, line_number;
   short  **array;
   struct tiff_header_struct *image_header;
...
extern insert_short_into_buffer(buffer, start, number){
    char  buffer[];
    int   start;
    short number;
...
extern insert_ushort_into_buffer(buffer, start, number){
    char  buffer[];
    int   start;
    unsigned short number;
...
extern insert_long_into_buffer(buffer, start, number){
    char buffer[];
    int  start;
    long number;
...
extern insert_ulong_into_buffer(buffer, start, number){
    char buffer[];
    int  start;
    unsigned long number;
...
extern round_off_image_size(image_header, length, width){
    int    *length, *width;
    struct tiff_header_struct *image_header;
...
extern does_not_exist(file_name){
    char file_name[];
...
extern read_bmp_file_header(file_name, file_header){
   char *file_name;
...
extern print_bmp_file_header(struct bmpfileheader *file_header){
...
extern read_bm_header(file_name,bmheader){
   char *file_name;
...
extern print_bm_header(bmheader){
   struct bitmapheader *bmheader;
...
extern read_color_table(file_name, rgb, size){
   char   *file_name;
   struct ctstruct *rgb;
   int    size;
...
extern print_color_table(struct ctstruct *rgb, int size)
{
   int i;
...
extern flip_image_array(the_image, rows, cols){
   long   cols, rows;
   short  **the_image;
...
extern read_bmp_image(file_name, array){
   char  *file_name;
   short **array;
...
extern create_allocate_bmp_file(file_name,file_header,bmheader){
   char  *file_name;
   struct bmpfileheader *file_header;
   struct bitmapheader  *bmheader;
...
extern create_bmp_file_if_needed(in_name, out_name, out_image){
   char in_name[], out_name[];
   short **out_image;
...
extern write_bmp_image(file_name, array){
   char   *file_name;
   short  **array;
...
extern int calculate_pad(width){
   long width;
...
extern int get_image_size(file_name, rows, cols){
   char *file_name;
   long *cols, *rows;
...
extern int get_bitsperpixel(file_name, bitsperpixel){
   char *file_name;
   long *bitsperpixel;
...
extern int is_a_tiff(file_name){
   char *file_name;
...
extern read_image_array(file_name, array){
   char  *file_name;
   short **array;
...
extern write_image_array(file_name, array){
   char  *file_name;
   short **array;
...
extern equate_tiff_headers(src, dest){
...
extern equate_bmpfileheaders(src, dest){
...
extern equate_bitmapheaders(src, dest){
...
extern int are_not_same_size(file1, file2){
   char *file1, *file2;
...
extern create_file_if_needed(in_name, out_name, array){
   char *in_name, *out_name;
   short **array;
...
extern create_image_file(in_name, out_name){
   char *in_name, *out_name;
...
create_resized_image_file(in_name, out_name,length, width){
   char *in_name, *out_name;
   long length, width;
